#
#  Be sure to run `pod spec lint PanGestureView.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "Arvindh Sukumar"
  # s.authors            = { "Arvindh Sukumar" => "arvindh.sukumar@gmail.com" }
  # s.social_media_url   = "http://twitter.com/arvindhsukumar"
